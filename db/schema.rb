...
ActiveRecord::Schema.define(version: 2019_03_12_193343) do

  # These are extensions that must be enabled in order to support this database
  enable_extension "plpgsql"

# Could not dump table "ingredients" because of following StandardError
#   Unknown type 'unit' for column 'default_unit'
...
#   Unknown type 'unit' for column 'unit'
  ...
  create_table "recipes", force: :cascade do |t|
    ...
    t.float "default_number_of_servings", default: 1.0, null: false
